...
public extension UIView {
    ...
    func toastViewForMessage(_ message: String?, title: String?, image: UIImage?, style: ToastStyle) throws -> UIView {
        ...
        if style.displayShadow {
            wrapperView.layer.shadowColor = UIColor.blue.cgColor
...
public struct ToastStyle {
     ...
     */
    public var backgroundColor: UIColor = .white //.init(red: 23 / 255.0, green: 146 / 255.0, blue: 161 / 255.0, alpha: 1.0)
     ...
     */
    public var shadowColor: UIColor = .init(red: 4 / 255.0, green: 194 / 255.0, blue: 209 / 255.0, alpha: 1.0)
     ...
     */
//    public var activityBackgroundColor: UIColor = UIColor.blue.withAlphaComponent(0.8)
    public var activityBackgroundColor: UIColor = .init(red: 4 / 255.0, green: 194 / 255.0, blue: 209 / 255.0, alpha: 0.8)
}
