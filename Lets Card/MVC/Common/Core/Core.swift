            ...
            if let whatsappURL = URL(string: urlString) {
                if UIApplication.shared.canOpenURL(whatsappURL as URL) {
                    ...
                    do {
                        ...
                        Toast.makeToast("There was an error while processing, please contact our support team.")
                        return
                    }
                } else {
                    Toast.makeToast("Cannot open Whatsapp, be sure Whatsapp is installed on your device.")
                }
            }
        }
    }
